...
public class RestControllerWpAndReports {
    ...
    public String processDataFormReport(Authentication authentication, @RequestBody FormReport data) {
        // Обработка данных
    ...
    public String processDataFormReport( @RequestBody FormReport data, @PathVariable Long id){
